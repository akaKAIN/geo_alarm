"""
Django settings for geo_alarm project.
...
WSGI_APPLICATION = 'geo_alarm.wsgi.application'
...
REST_FRAMEWORK = {
    # Не получилось ее прикрутить на скорую руку - дописал свою в методе получения queryset'a
